...
#define ATTITUDESTATE_OBJID				0x7421C7BA	// new name since VERSION_RELEASE_14_01_1

#define	FLIGHTSTATUS_OBJID				0x24D25E28

#define	MANUALCONTROLCOMMAND_OBJID			0x265BA97E
#define	MANUALCONTROLCOMMAND_OBJID_META			0x265BA97F

#define GPSPOSITION_OBJID				0xE2A323B6
#define GPSPOSITIONSENSOR_OBJID 			0xA529B6FE	// new name since VERSION_RELEASE_14_01_1

#define GPSTIME_OBJID					0x1E2F477E

#define GPSVELOCITY_OBJID				0x8245DC80
#define GPSVELOCITYSENSOR_OBJID				0xBC57454	// new name since VERSION_RELEASE_14_01_1
...
#define	MANUALCONTROLCOMMAND_OBJID_META_ACCESS		0
#define	MANUALCONTROLCOMMAND_OBJID_META_GCS_ACCESS		1
#define	MANUALCONTROLCOMMAND_OBJID_META_TELEMETRY_ACKED		2
#define	MANUALCONTROLCOMMAND_OBJID_META_GCS_TELEMETRY_ACKED		3
#define	MANUALCONTROLCOMMAND_OBJID_META_TELEMETRY_UPDATE_MODE		4
#define	MANUALCONTROLCOMMAND_OBJID_META_GCS_TELEMETRY_UPDATE_MODE		6
#define	MANUALCONTROLCOMMAND_OBJID_META_LOGGING_UPDATE_MODE		8
...
#define	SYSTEMALARMS_ALARM_STABILIZATION		15
...
typedef enum {
	MANUALCONTROLCOMMAND_META_ACCESS_READONLY = 0,
	MANUALCONTROLCOMMAND_META_ACCESS_READWRITE = 1
} manualcontrolcommand_meta_access_t;
